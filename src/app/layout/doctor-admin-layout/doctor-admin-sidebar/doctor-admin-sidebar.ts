...
import {DoctorAdminSidebarMenu} from '../doctor-admin-sidebar-menu/doctor-admin-sidebar-menu';

@Component({
  selector: 'app-doctor-admin-sidebar',
  imports: [
    NgClass,
    NgOptimizedImage,
    DoctorAdminSidebarMenu
  ],
  templateUrl: './doctor-admin-sidebar.html',
  styleUrl: './doctor-admin-sidebar.scss',
  standalone: true
})
export class DoctorAdminSidebar {
